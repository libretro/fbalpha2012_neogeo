...
void NeoMapBank(void)
{
	SekMapMemory(Neo68KROMActive + nNeo68KROMBank, 0x200000, 0x2FFFFF, SM_ROM);
}

void NeoMap68KFix(void)
{
...
static double neogeoGetTime(void)
{
...
static void NeoMapActiveCartridge(void)
{
	if (!(nNeoSystemType & NEO_SYS_CART))
   {
		nNeoActiveSlot = 0;
...
static UINT8 NeoCDCommsread(void)
{
	UINT8 ret = 0;
...
static void NeoCDCommsReset(void)
{
...
static char* LC8915InitTransfer(void)
{
...
static void LC8915EndTransfer(void)
{
