...
UINT8 nSpriteEnable = 0xFF;	// Can be used externally to select which Sprites to show
...
INT32 (__cdecl* BurnExtCartridgeSetupCallback)(enum BurnCartridgeCommand nCommand) = NULL;
